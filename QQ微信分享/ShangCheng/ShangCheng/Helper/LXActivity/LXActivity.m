...
#define SHAREBUTTON_INTERVAL_WIDTH              ([UIScreen mainScreen].bounds.size.width - SHAREBUTTON_WIDTH*3) / 4.0f
#define SHAREBUTTON_INTERVAL_HEIGHT             35

#define SHARETITLE_WIDTH                        50
#define SHARETITLE_HEIGHT                       20
#define SHARETITLE_INTERVAL_WIDTH               ([UIScreen mainScreen].bounds.size.width - SHARETITLE_WIDTH*3) / 4.0f
...
- (void)creatButtonsWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle shareButtonTitles:(NSArray *)shareButtonTitlesArray withShareButtonImagesName:(NSArray *)shareButtonImagesNameArray
{
    ...
    [UIView animateWithDuration:ANIMATE_DURATION animations:^{
        [self.backGroundView setFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height-self.LXActivityHeight - 60, [UIScreen mainScreen].bounds.size.width, self.LXActivityHeight + 60)];
